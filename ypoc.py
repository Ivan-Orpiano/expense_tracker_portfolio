...
# Configuration
app.config['SECRET_KEY'] = 'your-secret-key-here-change-in-production'  # Needed for flash messages
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///expenses.db'  # SQLite database file
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False  # Disable tracking to save resources

# Initialize database
db = SQLAlchemy(app)

# Database Model - represents the expenses table
